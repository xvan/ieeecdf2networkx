...
class IEEECDFParser(object):
    ...
    def __init__(self, source_filename):
        ...
        self.bus_data_map = {
            ...
            "loss_zone_number": {"start": 21, "end": 23, "format_func": int},
            "bus_type": {"start": 24, "end": 26, "format_func": int},
            "V": {"start": 27, "end": 32, "format_func": float},
            "theta": {"start": 33, "end": 40, "format_func": lambda x: radians(float(x))},
            "load_p": {"start": 41, "end": 49, "format_func": float},
            "load_q": {"start": 50, "end": 58, "format_func": float},
            "gen_p": {"start": 59, "end": 67, "format_func": float},
            "gen_q": {"start": 68, "end": 76, "format_func": float},
            "base_kv": {"start": 77, "end": 83, "format_func": float},
            "desired_volts": {"start": 84, "end": 89, "format_func": float},
            "max_limit": {"start": 90, "end": 98, "format_func": float},
            "min_limit": {"start": 99, "end": 106, "format_func": float},
            "shunt_g": {"start": 107, "end": 112, "format_func": float},
            "shunt_b": {"start": 113, "end": 119, "format_func": float},
            "remote_bus_num": {"start": 120, "end": 127, "format_func": int}
        }

        self.branch_data_map = {
            "tap_bus_num": {"start": 0, "end": 4, "format_func": int},
            "z_bus_num": {"start": 5, "end": 9, "format_func": int},
            ...
            "circuit": {"start": 16, "end": 17, "format_func": int},
            "type": {"start": 18, "end": 19, "format_func": lambda x: "t_line" if int(x) == 0 else "fixed_tap" if int(x) == 1 else "unsupported"},
            "r": {"start": 20, "end": 29, "format_func": float},
            "x": {"start": 30, "end": 39, "format_func": float},
            "b": {"start": 40, "end": 50, "format_func": float},
            "line_mva_rating_1": {"start": 51, "end": 55, "format_func": int},
            ...
            "side": {"start": 73, "end": 74, "format_func": lambda x: "term" if int(x) == 0 else "tap_bus" if int(x) == 1 else "z_bus"},
            "final_ratio": {"start": 75, "end": 82, "format_func": float},
            "final_angle": {"start": 83, "end": 89, "format_func": float},
            "min_tap": {"start": 90, "end": 96, "format_func": float},
            "max_tap": {"start": 97, "end": 104, "format_func": float},
            "step_size": {"start": 105, "end": 111, "format_func": float},
            "min_limit": {"start": 112, "end": 117, "format_func": float},
            "max_limit": {"start": 118, "end": 126, "format_func": float}
        }
        ...
        for line_number, line in enumerate(self.source_file):
            ...
            if title_data is None:
                ...
                if line[0:4] == "-999":
                    ...
                    #if "shunt_b" not in Gn.node[bus_a]:
                    #    Gn.node[bus_a]["shunt_b"]=0
                    #if "shunt_b" not in Gn.node[bus_b]:
                    #    Gn.node[bus_b]["shunt_b"]=0

                    Gn.node[bus_a]["attr_dict"]["shunt_b"] += 0.5*branch_data["b"]
                    Gn.node[bus_b]["attr_dict"]["shunt_b"] += 0.5*branch_data["b"]
